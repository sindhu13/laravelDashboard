...
@section('title', '| Sales Per Leasing')

@section('content')

<div class="col-lg-10 col-lg-offset-1">
  <h1><i class="fa fa-users"></i> Sales Per Leasing </h1>
  <hr>
  {!! Form::open(['method' => 'get', 'url' => '/salesperleasing', 'class' => 'navbar-form navbar-right', 'role' => 'search']) !!}
      ...
      <table class="table table-bordered table-striped" style="background-color: #f2f2f2;">
        ...
        <tbody>
          ...
          @foreach($leasings as $leasing)
            ...
            @php($gsstot += $sstot)
            <tr>
              <td style="font-weight: bold;">{{ $leasing->leasing }}</td>
          ...
          @endforeach {{-- End Foreach Leasings --}}
