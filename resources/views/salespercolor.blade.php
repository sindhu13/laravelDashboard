...
<div class="col-lg-10 col-lg-offset-1">
  ...
  <hr>
  {!! Form::open(['method' => 'get', 'url' => '/salespercolor', 'class' => 'navbar-form navbar-right', 'role' => 'search']) !!}
      ...
      <table class="table table-bordered table-striped" style="background-color: #f2f2f2;">
        ...
        <tbody>
          ...
          @foreach($colors as $color)
            ...
            @php($gsstot += $sstot)
            <tr>
              <td style="font-weight: bold;">{{ $color->color .' - '. $color->code }}</td>
